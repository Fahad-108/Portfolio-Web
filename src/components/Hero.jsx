      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-gutter w-full grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center pb-10 pt-28 relative z-10">
        ...
        <div className="flex flex-col gap-y-6 md:gap-y-10 text-left">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="border border-white inline-flex items-center gap-3 glass-premium px-6 py-2.5 rounded-full">
          ...
          <p className="max-w-xl mx-auto md:mx-0 font-body-lg text-body-lg text-on-surface-variant leading-relaxed opacity-80">
            I build robust backend systems and clean, highly interactive user interfaces. Specializing in the{" "}
            <span className="text-on-surface font-bold decoration-primary/50 underline underline-offset-4 decoration-2">
              MERN Stack
            </span>
            , Node.js, and performance optimization to turn complex ideas into production-ready web applications.
          </p>
          ...
          <div className="md:hidden w-full flex justify-center items-center py-4 my-2">
            <div className="relative w-full max-w-[260px] xs:max-w-[280px] aspect-square flex items-center justify-center mx-auto">
              <div className="absolute w-[240px] h-[240px] bg-primary/5 rounded-full blur-[100px]"></div>

              {/* Main Glass Container */}
              <div className="relative w-full h-full card-surface-premium rounded-[32px] overflow-hidden p-2 group">
                ...
                <div className="absolute bottom-3 left-3 right-3">
                  <div className="card-surface-premium backdrop-blur-3xl rounded-xl p-2.5 flex items-center justify-between">
                    ...
                    <span className="text-[8px] font-label-mono text-primary font-black px-2 py-0.5 rounded-full card-surface-premium">
                      2026
                    </span>
                  </div>
                </div>
              ...
              <div className="absolute -top-2 -right-2 animate-float delay-1">
                <div className="card-surface-premium p-2.5 rounded-xl border border-primary/40 shadow-xl">
                  <Cpu className="text-primary" size={20} />
                </div>
              </div>
              <div className="absolute -bottom-3 -left-2 animate-float delay-2">
                <div className="card-surface-premium p-2.5 rounded-xl border border-secondary/40 shadow-xl">
          ...
          <div className="flex flex-row sm:flex-row items-center gap-3 pt-2">
            <button
              ...
              className="flex-1 px-5 py-4 rounded-2xl font-extrabold flex items-center justify-center gap-3 group bg-primary text-surface hover:bg-primary/90 border border-primary/25 shadow-md hover:-translate-y-1 transition-all duration-300 active:scale-95"
            >
              View Projects
            ...
            <button
              ...
              className="flex-1 px-5 py-4 rounded-2xl font-extrabold flex items-center justify-center hover:bg-on-surface/5 border border-outline-variant/30 transition-all active:scale-95"
            >
              Get in Touch
            </button>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-6 pt-2">
            <a
              className="card-surface-premium w-14 h-14 flex items-center justify-center rounded-2xl hover:text-primary hover:border-primary/50 transition-all hover:-translate-y-1"
        ...
        <div className="hidden md:flex relative justify-center items-center h-[500px] lg:h-[700px]">
          <div className="absolute w-[450px] h-[450px] bg-primary/5 rounded-full blur-[160px]"></div>

          {/* Layered Card Setup */}
          <div className="relative w-full max-w-[340px] md:max-w-[480px] aspect-square flex items-center justify-center mx-auto">
            {/* Main Glass Container */}
            <div className="relative w-full h-full card-surface-premium rounded-[36px] md:rounded-[56px] overflow-hidden p-2 md:p-2.5 group">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/40 via-transparent to-secondary/30 opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
              ...
              <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8">
                <div className="card-surface-premium backdrop-blur-3xl rounded-2xl md:rounded-3xl p-3 md:p-5 flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-label-mono text-primary font-black px-3 py-1 rounded-full card-surface-premium">
                    2026
                  </span>
                </div>
              </div>
            ...
            <div className="absolute -top-6 -right-4 animate-float delay-1">
              <div className="card-surface-premium p-6 rounded-[32px] border border-primary/40 shadow-2xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
                <Cpu className="text-primary" size={48} />
              </div>
            </div>
            <div className="absolute -bottom-12 -left-12 animate-float delay-2">
              <div className="card-surface-premium p-6 rounded-[32px] border border-secondary/40 shadow-2xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
